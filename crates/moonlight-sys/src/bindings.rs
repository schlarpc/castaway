...
// rev e41355ea01670fd4c830b384009d31dd0339a705 — see nix/moonlight-common-c.nix.
// Regenerate by hand with bindgen against the pinned source; do not edit by hand.
// NOTE: there is no `moonlight-bindings` flake check — this line used to claim one. See
// the crate docs in lib.rs for what that means for ABI drift.
#![allow(
...
pub const COLORSPACE_REC_601: i32 = 0;
pub const COLORSPACE_REC_709: i32 = 1;
pub const COLORSPACE_REC_2020: i32 = 2;
pub const COLOR_RANGE_LIMITED: i32 = 0;
pub const COLOR_RANGE_FULL: i32 = 1;
pub const ENCFLG_NONE: i32 = 0;
pub const ENCFLG_AUDIO: i32 = 1;
pub const ENCFLG_VIDEO: i32 = 2;
pub const ENCFLG_ALL: i64 = 4294967295;
pub const BUFFER_TYPE_PICDATA: i32 = 0;
pub const BUFFER_TYPE_SPS: i32 = 1;
pub const BUFFER_TYPE_PPS: i32 = 2;
pub const BUFFER_TYPE_VPS: i32 = 3;
pub const FRAME_TYPE_PFRAME: i32 = 0;
pub const FRAME_TYPE_IDR: i32 = 1;
pub const AUDIO_CONFIGURATION_MAX_CHANNEL_COUNT: i32 = 8;
pub const VIDEO_FORMAT_H264: i32 = 1;
pub const VIDEO_FORMAT_H264_HIGH8_444: i32 = 4;
pub const VIDEO_FORMAT_H265: i32 = 256;
pub const VIDEO_FORMAT_H265_MAIN10: i32 = 512;
pub const VIDEO_FORMAT_H265_REXT8_444: i32 = 1024;
pub const VIDEO_FORMAT_H265_REXT10_444: i32 = 2048;
pub const VIDEO_FORMAT_AV1_MAIN8: i32 = 4096;
pub const VIDEO_FORMAT_AV1_MAIN10: i32 = 8192;
pub const VIDEO_FORMAT_AV1_HIGH8_444: i32 = 16384;
pub const VIDEO_FORMAT_AV1_HIGH10_444: i32 = 32768;
pub const VIDEO_FORMAT_MASK_H264: i32 = 15;
pub const VIDEO_FORMAT_MASK_H265: i32 = 3840;
pub const VIDEO_FORMAT_MASK_AV1: i32 = 61440;
pub const VIDEO_FORMAT_MASK_10BIT: i32 = 43520;
pub const VIDEO_FORMAT_MASK_YUV444: i32 = 52228;
pub const CAPABILITY_DIRECT_SUBMIT: i32 = 1;
pub const CAPABILITY_REFERENCE_FRAME_INVALIDATION_AVC: i32 = 2;
pub const CAPABILITY_REFERENCE_FRAME_INVALIDATION_HEVC: i32 = 4;
pub const CAPABILITY_SLOW_OPUS_DECODER: i32 = 8;
pub const CAPABILITY_SUPPORTS_ARBITRARY_AUDIO_DURATION: i32 = 16;
pub const CAPABILITY_PULL_RENDERER: i32 = 32;
pub const CAPABILITY_REFERENCE_FRAME_INVALIDATION_AV1: i32 = 64;
pub const DR_OK: i32 = 0;
pub const DR_NEED_IDR: i32 = -1;
pub const STAGE_NONE: i32 = 0;
pub const STAGE_PLATFORM_INIT: i32 = 1;
pub const STAGE_NAME_RESOLUTION: i32 = 2;
pub const STAGE_AUDIO_STREAM_INIT: i32 = 3;
pub const STAGE_RTSP_HANDSHAKE: i32 = 4;
pub const STAGE_CONTROL_STREAM_INIT: i32 = 5;
pub const STAGE_VIDEO_STREAM_INIT: i32 = 6;
pub const STAGE_INPUT_STREAM_INIT: i32 = 7;
pub const STAGE_CONTROL_STREAM_START: i32 = 8;
pub const STAGE_VIDEO_STREAM_START: i32 = 9;
pub const STAGE_AUDIO_STREAM_START: i32 = 10;
pub const STAGE_INPUT_STREAM_START: i32 = 11;
pub const STAGE_MAX: i32 = 12;
pub const ML_ERROR_GRACEFUL_TERMINATION: i32 = 0;
...
pub const CONN_STATUS_OKAY: i32 = 0;
pub const CONN_STATUS_POOR: i32 = 1;
pub const DS_EFFECT_PAYLOAD_SIZE: i32 = 10;
pub const DS_EFFECT_RIGHT_TRIGGER: i32 = 4;
pub const DS_EFFECT_LEFT_TRIGGER: i32 = 8;
pub const SCM_H264: i32 = 1;
pub const SCM_HEVC: i32 = 256;
pub const SCM_HEVC_MAIN10: i32 = 512;
pub const SCM_AV1_MAIN8: i32 = 65536;
pub const SCM_AV1_MAIN10: i32 = 131072;
pub const SCM_H264_HIGH8_444: i32 = 262144;
pub const SCM_HEVC_REXT8_444: i32 = 524288;
pub const SCM_HEVC_REXT10_444: i32 = 1048576;
pub const SCM_AV1_HIGH8_444: i32 = 2097152;
pub const SCM_AV1_HIGH10_444: i32 = 4194304;
pub const SCM_MASK_H264: i32 = 262145;
pub const SCM_MASK_HEVC: i32 = 1573632;
pub const SCM_MASK_AV1: i32 = 6488064;
pub const SCM_MASK_10BIT: i32 = 5374464;
pub const SCM_MASK_YUV444: i32 = 8126464;
pub const LI_ERR_UNSUPPORTED: i32 = -5501;
pub const LI_TOUCH_EVENT_HOVER: i32 = 0;
pub const LI_TOUCH_EVENT_DOWN: i32 = 1;
pub const LI_TOUCH_EVENT_UP: i32 = 2;
pub const LI_TOUCH_EVENT_MOVE: i32 = 3;
pub const LI_TOUCH_EVENT_CANCEL: i32 = 4;
pub const LI_TOUCH_EVENT_BUTTON_ONLY: i32 = 5;
pub const LI_TOUCH_EVENT_HOVER_LEAVE: i32 = 6;
pub const LI_TOUCH_EVENT_CANCEL_ALL: i32 = 7;
pub const LI_ROT_UNKNOWN: i32 = 65535;
pub const LI_TOOL_TYPE_UNKNOWN: i32 = 0;
pub const LI_TOOL_TYPE_PEN: i32 = 1;
pub const LI_TOOL_TYPE_ERASER: i32 = 2;
pub const LI_PEN_BUTTON_PRIMARY: i32 = 1;
pub const LI_PEN_BUTTON_SECONDARY: i32 = 2;
pub const LI_PEN_BUTTON_TERTIARY: i32 = 4;
pub const LI_TILT_UNKNOWN: i32 = 255;
pub const BUTTON_ACTION_PRESS: i32 = 7;
pub const BUTTON_ACTION_RELEASE: i32 = 8;
pub const BUTTON_LEFT: i32 = 1;
pub const BUTTON_MIDDLE: i32 = 2;
pub const BUTTON_RIGHT: i32 = 3;
pub const BUTTON_X1: i32 = 4;
pub const BUTTON_X2: i32 = 5;
pub const KEY_ACTION_DOWN: i32 = 3;
pub const KEY_ACTION_UP: i32 = 4;
pub const MODIFIER_SHIFT: i32 = 1;
pub const MODIFIER_CTRL: i32 = 2;
pub const MODIFIER_ALT: i32 = 4;
pub const MODIFIER_META: i32 = 8;
pub const SS_KBE_FLAG_NON_NORMALIZED: i32 = 1;
pub const A_FLAG: i32 = 4096;
pub const B_FLAG: i32 = 8192;
pub const X_FLAG: i32 = 16384;
pub const Y_FLAG: i32 = 32768;
pub const UP_FLAG: i32 = 1;
pub const DOWN_FLAG: i32 = 2;
pub const LEFT_FLAG: i32 = 4;
pub const RIGHT_FLAG: i32 = 8;
pub const LB_FLAG: i32 = 256;
pub const RB_FLAG: i32 = 512;
pub const PLAY_FLAG: i32 = 16;
pub const BACK_FLAG: i32 = 32;
pub const LS_CLK_FLAG: i32 = 64;
pub const RS_CLK_FLAG: i32 = 128;
pub const SPECIAL_FLAG: i32 = 1024;
pub const PADDLE1_FLAG: i32 = 65536;
pub const PADDLE2_FLAG: i32 = 131072;
pub const PADDLE3_FLAG: i32 = 262144;
pub const PADDLE4_FLAG: i32 = 524288;
pub const TOUCHPAD_FLAG: i32 = 1048576;
pub const MISC_FLAG: i32 = 2097152;
pub const LI_CTYPE_UNKNOWN: i32 = 0;
pub const LI_CTYPE_XBOX: i32 = 1;
pub const LI_CTYPE_PS: i32 = 2;
pub const LI_CTYPE_NINTENDO: i32 = 3;
pub const LI_CCAP_ANALOG_TRIGGERS: i32 = 1;
pub const LI_CCAP_RUMBLE: i32 = 2;
pub const LI_CCAP_TRIGGER_RUMBLE: i32 = 4;
pub const LI_CCAP_TOUCHPAD: i32 = 8;
pub const LI_CCAP_ACCEL: i32 = 16;
pub const LI_CCAP_GYRO: i32 = 32;
pub const LI_CCAP_BATTERY_STATE: i32 = 64;
pub const LI_CCAP_RGB_LED: i32 = 128;
pub const LI_CCAP_DUAL_TOUCHPAD: i32 = 256;
pub const LI_MOTION_TYPE_ACCEL: i32 = 1;
pub const LI_MOTION_TYPE_GYRO: i32 = 2;
pub const LI_BATTERY_STATE_UNKNOWN: i32 = 0;
pub const LI_BATTERY_STATE_NOT_PRESENT: i32 = 1;
pub const LI_BATTERY_STATE_DISCHARGING: i32 = 2;
pub const LI_BATTERY_STATE_CHARGING: i32 = 3;
pub const LI_BATTERY_STATE_NOT_CHARGING: i32 = 4;
pub const LI_BATTERY_STATE_FULL: i32 = 5;
pub const LI_BATTERY_PERCENTAGE_UNKNOWN: i32 = 255;
pub const ML_PORT_INDEX_TCP_47984: i32 = 0;
pub const ML_PORT_INDEX_TCP_47989: i32 = 1;
pub const ML_PORT_INDEX_TCP_48010: i32 = 2;
pub const ML_PORT_INDEX_UDP_47998: i32 = 8;
pub const ML_PORT_INDEX_UDP_47999: i32 = 9;
pub const ML_PORT_INDEX_UDP_48000: i32 = 10;
pub const ML_PORT_INDEX_UDP_48010: i32 = 11;
pub const ML_PORT_FLAG_ALL: i64 = 4294967295;
pub const ML_PORT_FLAG_TCP_47984: i32 = 1;
pub const ML_PORT_FLAG_TCP_47989: i32 = 2;
pub const ML_PORT_FLAG_TCP_48010: i32 = 4;
pub const ML_PORT_FLAG_UDP_47998: i32 = 256;
pub const ML_PORT_FLAG_UDP_47999: i32 = 512;
pub const ML_PORT_FLAG_UDP_48000: i32 = 1024;
pub const ML_PORT_FLAG_UDP_48010: i32 = 2048;
pub const ML_TEST_RESULT_INCONCLUSIVE: i64 = 4294967295;
pub const LI_FF_PEN_TOUCH_EVENTS: i32 = 1;
pub const LI_FF_CONTROLLER_TOUCH_EVENTS: i32 = 2;
unsafe extern "C" {
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _DECODE_UNIT"][::std::mem::size_of::<_DECODE_UNIT>() - 64usize];
    ...
    ["Offset of field: _DECODE_UNIT::receiveTimeUs"]
        [::std::mem::offset_of!(_DECODE_UNIT, receiveTimeUs) - 16usize];
    ["Offset of field: _DECODE_UNIT::enqueueTimeUs"]
        [::std::mem::offset_of!(_DECODE_UNIT, enqueueTimeUs) - 24usize];
    ["Offset of field: _DECODE_UNIT::presentationTimeUs"]
        [::std::mem::offset_of!(_DECODE_UNIT, presentationTimeUs) - 32usize];
    ["Offset of field: _DECODE_UNIT::rtpTimestamp"]
        [::std::mem::offset_of!(_DECODE_UNIT, rtpTimestamp) - 40usize];
    ["Offset of field: _DECODE_UNIT::fullLength"]
        [::std::mem::offset_of!(_DECODE_UNIT, fullLength) - 44usize];
    ["Offset of field: _DECODE_UNIT::bufferList"]
        [::std::mem::offset_of!(_DECODE_UNIT, bufferList) - 48usize];
    ["Offset of field: _DECODE_UNIT::hdrActive"]
        [::std::mem::offset_of!(_DECODE_UNIT, hdrActive) - 56usize];
    ["Offset of field: _DECODE_UNIT::colorspace"]
        [::std::mem::offset_of!(_DECODE_UNIT, colorspace) - 57usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _RTP_AUDIO_STATS"][::std::mem::size_of::<_RTP_AUDIO_STATS>() - 28usize];
    ["Alignment of _RTP_AUDIO_STATS"][::std::mem::align_of::<_RTP_AUDIO_STATS>() - 4usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountAudio"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountAudio) - 0usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountFec"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountFec) - 4usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountFecRecovered"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountFecRecovered) - 8usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountFecFailed"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountFecFailed) - 12usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountOOS"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountOOS) - 16usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountInvalid"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountInvalid) - 20usize];
    ["Offset of field: _RTP_AUDIO_STATS::packetCountFecInvalid"]
        [::std::mem::offset_of!(_RTP_AUDIO_STATS, packetCountFecInvalid) - 24usize];
};
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of _RTP_VIDEO_STATS"][::std::mem::size_of::<_RTP_VIDEO_STATS>() - 28usize];
    ["Alignment of _RTP_VIDEO_STATS"][::std::mem::align_of::<_RTP_VIDEO_STATS>() - 4usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountVideo"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountVideo) - 0usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountFec"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountFec) - 4usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountFecRecovered"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountFecRecovered) - 8usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountFecFailed"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountFecFailed) - 12usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountOOS"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountOOS) - 16usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountInvalid"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountInvalid) - 20usize];
    ["Offset of field: _RTP_VIDEO_STATS::packetCountFecInvalid"]
        [::std::mem::offset_of!(_RTP_VIDEO_STATS, packetCountFecInvalid) - 24usize];
};
