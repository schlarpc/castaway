...
pub fn disc(buf: &mut [u8], width: u32, height: u32, cx: f32, cy: f32, diameter: f32, color: Rgba) {
    let r = diameter / 2.0;
    fill_sdf(
        buf,
        width,
...
pub fn rounded_rect(buf: &mut [u8], width: u32, height: u32, rect: Rect, radius: f32, color: Rgba) {
